...
WORKBOOK_VARIABLES: tuple[WorkbookVariableDefinition, ...] = (
    ...
    WorkbookVariableDefinition(
        ...
        "Capacity",
        "Live Peak Power",
        "input.peak_schedule.live_peak_power_mwh + capacities.peak_power_mwh fallback",
        status="implemented",
        notes="Peak Schedule can optionally provide live_peak_power_mwh; Cap10 is used as fallback.",
    ),
    ...
    WorkbookVariableDefinition(
        ...
        "summary.p1_forecast_22h_curtailment_mwh + rule lookahead forecast curtailment",
        status="implemented",
    ),
    WorkbookVariableDefinition(
        "P2",
        ...
        "summary.p2_live_curtailment_mwh + MarketDecision.curtailment_mwh",
        status="implemented",
    ),
    WorkbookVariableDefinition(
        "P3",
        ...
        "summary.p3_monthly_peak_90_deficit_mwh",
        status="implemented",
    ),
    WorkbookVariableDefinition(
        "P4",
        ...
        "summary.p4_annual_ppa_generation_5pct_mwh",
        status="implemented",
    ),
    WorkbookVariableDefinition(
        "P5",
        ...
        "summary.p5_365d_generation_mwh",
        status="implemented",
    ),
)
...
WORKBOOK_CASES: tuple[WorkbookCaseDefinition, ...] = (
    WorkbookCaseDefinition(
        ...
        "non_peak_workbook_dispatch",
        "implemented",
        "Remaining workbook parity work is covered by explicit MODEL v2 scenario tests.",
    ),
    WorkbookCaseDefinition(
        "Case 3",
        "Non-peak",
    ...
    WorkbookCaseDefinition(
        ...
        "non_peak_workbook_dispatch",
        "implemented",
        "Tariff order uses T1 PPA tariff versus interval T2 merchant price.",
    ),
    WorkbookCaseDefinition(
        "Case 6/7",
        "Peak",
    ...
    WorkbookCaseDefinition(
        ...
        "peak_power_obligation",
        "implemented",
        "Uses merchant power when monthly peak compliance has a gap and live T2 is below 0.8 x T3.",
    ),
    WorkbookCaseDefinition(
        "Case 8",
        "Non-peak",
